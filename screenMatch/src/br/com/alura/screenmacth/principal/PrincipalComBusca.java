...
import br.com.alura.screenmacth.excecao.ErroDeCoversaoDeAnoException;
import br.com.alura.screenmacth.modelos.Titulo;
import br.com.alura.screenmacth.modelos.TituloOmdb;
...
public class PrincipalComBusca {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        while (!busca.equalsIgnoreCase("sair")){
            ...
            String endereco = "https://www.omdbapi.com/?t=" + busca.replace(" ", "+") + "&apikey=9e9d67d4";
            try {
